...
- Current English voice: `aMSt68OGf4xUZAnLpTU8` (Juniper); Mandarin:
  `4AfodMgwXps9oZFhHzoj`. Do not substitute older audition voices or invent a new voice.
...
- Current E01 English score points to `2026-09-17-e01-hook`; E02 English points to
  `2026-09-17-e02-juniper`. Mandarin assets are in `2026-09-17-e01-mandarin` and
  `2026-09-17-e02-mandarin`. Read the active JSON for current identities rather than assuming
  the newest folder name is active.
- E01 Mandarin intentionally retains its prior wording/audio through an explicit English-only
  hook variation: `docs/series-narration/2026-09-17-e01-hook/english-variation.json` and the
  active `semantic-hook-v3` score. Do not "fix" its older English source hash by overwriting
  provenance or reverting the English hook. Update semantic anchors deliberately if affected.
