...
- **Phase 3 started 2026-07-15 under decision
  ...
  overlap with the tail of 2b's then-in-flight evidence run; after that run exited, the maker
  directed completion — decision
  [0008](decisions/0008-phase3-completes-after-2b-exit.md), charter v1.6, constraints carried
  condition-independent. Active Phase 3 plan:
...
- **Charter is at v1.6** (2026-07-16, decision
  [0008](decisions/0008-phase3-completes-after-2b-exit.md) — Phase 3 completes after the 2b
  run's exit, maker-directed). Before that, v1.5 (2026-07-15, decision
