...
| Fig. 7 (ρ=0.15 ridged sidebranches) | 600,600,48; cap 40k | far-field @ 18150, attached 511993 | **Reproduced (class).** Six ridged arms, serrated sidebranches with their own ridges, detached leaf plates between arms — visibly sparser fill than the paper's larger crystal; consistent with our half-size domain/reservoir, not a morphology mismatch. | Host note: the charter prefers the Windows box for long
