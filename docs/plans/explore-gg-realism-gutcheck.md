...
| Fig. 29 (needle) | 128,128,768; cap 30k | far-field @ 25075, attached 220173; bbox 404 long × 36 wide | **Reproduced.** Same needle class: segmented hexagonal shaft with stepped bands, tapered spear tips with fine spiky fringes. (Render note, also applied forward: side-view captures use the screen-fixed background — the static backdrop plane is edge-on at tilt 90.) | Host note: the charter prefers the Windows box for long
