...
Project Document — v1.12, July 2026
...
Current revision. v1.12 (2026-07-19) — decision 0014: aggregate v5 accepts its directly metered smoother drift only within an operation-count-derived float64 roundoff bound; both that absolute bound and the three-term divergence tolerance are load-bearing. Legacy-v3, aggregate-v4, and completed Phase 4 meanings stay frozen (§2.4, Phase 2b).
