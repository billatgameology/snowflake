...
Project Document — v1.5, July 2026
...
Phases 1 and 2 can run in parallel; everything else is sequential. (One recorded exception, 2026-07-15, decision 0007: Phase 3's development-visualization work may overlap the tail of Phase 2b's pre-registered evidence run — Phase 3's gate rests only on Phase 2a machinery, and Phase 2b's gate still closes only on its own recorded result.) Each milestone has a done when.
