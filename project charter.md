...
Project Document — v1.14, July 2026
...
Current revision. v1.14 (2026-07-23) — decision 0016: the Windows Ryzen 7 5700G / 64 GB / RTX 3080 10 GB system is the primary Phase 5 and Phase 6 host, while the previously documented M4 Mac is retained as the mandatory Metal conformance lane. The two-backend Phase 5 gate, ≈8M-cell preview target, and bounded-dispatch requirement remain unchanged; the ≈130M-cell bake budget is adapter-dependent rather than presumed to fit the primary GPU (§3.1, Phases 5–6).
...
130M-cell memory-fit claim without weakening the Phase 5 gate.
