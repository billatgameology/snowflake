...
Project Document — v1.11, July 2026
...
Current revision. v1.11 (2026-07-19) — decision 0013: the new aggregate v5 policy retains dual convergence and all v4 surface physics, but its divergence identity includes the independently metered signed float64 reflecting-smoother drift; legacy-v3, aggregate-v4, and completed Phase 4 meanings stay frozen (§2.4, Phase 2b).
