...
Project Document — v1.13, July 2026
...
Current revision. v1.13 (2026-07-19) — decision 0014 follow-up: the operation-count-derived aggregate-v5 drift bound includes a minimum-subnormal absolute ULP floor, so the accepted positive-subnormal field domain cannot collapse the bound to zero. The registered 0.002 gate condition, legacy-v3, aggregate-v4, and completed Phase 4 meanings stay frozen (§2.4, Phase 2b).
