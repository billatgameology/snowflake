...
console.log(`  measured-only (arm scope) ${report.headlineAgree}/${report.headlineTotal}`);
console.log(`  measured-only (common)    ${report.headlineAgreeCommonDenominator}/${report.headlineTotalCommonDenominator}`);
console.log("  registered ADR 0026 conservative-intersection headline: NOT PRODUCED");
