...
export function phase10C0VS6LockPathsForPacketId(packetId: string): Readonly<{
  packageLockPath: typeof PHASE10_C0V_S6_PACKAGE_LOCK_PATH;
  ...
  return Object.freeze({
    packageLockPath: PHASE10_C0V_S6_PACKAGE_LOCK_PATH,
    packetLockPath: PHASE10_C0V_S6_PACKET_LOCK_PATHS[packetId as Phase10C0VS6PacketId],
  });
}
...
export interface Phase10C0VS6AncestryAuthority {
  ...
  readonly implementationFreezeRule: "common-first-introduction-commit-of-execution-v2-authority-and-callable-closure";
...
export interface Phase10C0VS6PreflightObservedContract {
  ...
  readonly packetCataloguePath: "research/phase10-execution-v2/packet-catalogue.json";
  readonly cleanWorktreeRequired: true;
...
export interface Phase10C0VS6RetainedPreflightPass {
  ...
  readonly observed: {
    ...
    readonly packageLockPath: "out/phase10-execution-v2/locks/package.lock";
...
export interface Phase10C0VS6LauncherBoundaryRequestAuthority {
  readonly kind: "initial-auth" | "boundary-recheck" | "release-output";
  readonly boundaryId: string;
}

export interface Phase10C0VS6LauncherRunBoundaryRoster {
  readonly subrouteId: string;
  readonly requests: readonly Phase10C0VS6LauncherBoundaryRequestAuthority[];
}

export interface Phase10C0VS6LauncherBoundaryContract {
  readonly schema: "phase10-c0v-s6-launcher-boundary-contract-v1";
  readonly requestExactFields: readonly ["kind", "boundaryId"];
  readonly checkRequests: readonly Phase10C0VS6LauncherBoundaryRequestAuthority[];
  readonly runRosters: readonly Phase10C0VS6LauncherRunBoundaryRoster[];
  readonly derivationRule: "common-preflight-stage-install-then-terminal-candidate-then-selected-path-ordered-stage-install-then-optional-verification-stage-install-then-terminal-stage-install-then-path-bound-cleanup-and-release";
  readonly failureRule: "failure-is-strict-nonrelease-prefix-success-is-complete-roster-with-release-last";
}

export interface Phase10C0VS6PacketProtocol {
  readonly schema: typeof PHASE10_C0V_S6_PACKET_PROTOCOL_SCHEMA;
  readonly protocolId: string;
  readonly matrixId: typeof PHASE10_C0V_S6_MATRIX_ID;
  readonly packetId: Phase10C0VS6PacketId;
  readonly registryId: string;
  ...
  readonly launcherBoundaryContract: Phase10C0VS6LauncherBoundaryContract;
  readonly paths: {
...
export interface Phase10C0VS6RuntimeLauncherArgumentVector {
...
export interface Phase10C0VS6RuntimeLauncherContract {
  readonly schema: "phase10-c0v-s6-runtime-launcher-contract-v1";
  readonly launcherId: "phase10-c0v-s6-native-launcher-v1";
  readonly state: "design-frozen-source-absent";
  readonly sourcePath: "runner/native/phase10-c0v-s6-launcher.c";
  readonly executable: {
    readonly platform: "win32";
    readonly arch: "x64";
    readonly path: "runner/native/phase10-c0v-s6-launcher-win32-x64.exe";
    readonly resolution: "planned";
    readonly identity: null;
  };
  readonly repositoryRoot: "G:/Code Files/snowflake-phase10-evidence";
  readonly nodeExecutable: Phase10C0VS6ArtifactIdentity & {
    readonly platform: "win32";
    readonly arch: "x64";
    readonly version: "v24.13.1";
  };
  readonly gitExecutable: Phase10C0VS6ArtifactIdentity & {
    readonly platform: "win32";
    readonly arch: "x64";
    readonly version: "2.35.1.windows.2";
    readonly linkCount: number;
    readonly linkPolicy: "host-provenance-exact-path-and-bytes-repository-single-link-rule-not-applied";
  };
  readonly ambientInspectionRule: "enumerate-before-authority-reject-casefold-duplicates-node-ts-node-and-preexisting-marker-copy-no-ambient-values";
  readonly cleanEnvironment: readonly Readonly<{ readonly key: string; readonly value: string }>[];
  readonly launcherChannelContract: Readonly<{
    readonly schema: "phase10-c0v-s6-launcher-channel-contract-v1";
    readonly transport: "private-inherited-bidirectional-anonymous-pipes-first-frame-auth-v1";
    readonly maximumFrameBytes: number;
    readonly challengeBytes: number;
    readonly challengeEncoding: "lowercase-hex-exact-64";
    readonly challengeSource: "node-crypto-randombytes-fresh-per-request";
    readonly authenticationTimeoutMilliseconds: 30000;
    readonly authenticationTimingRule: "launcher-monotonic-successful-child-create-to-complete-request-node-parent-hrtime-complete-request-write-to-complete-response-and-for-release-exact-eof-under-same-deadline-equality-accepted-plus-one-millisecond-fail-stop";
    readonly requestSchema: "phase10-c0v-s6-launcher-challenge-v1";
    readonly requestDomain: "phase10-c0v-s6-native-launcher-auth-v1";
    readonly requestExactFields: readonly string[];
    readonly responseSchema: "phase10-c0v-s6-launcher-response-v1";
    readonly responseExactFields: readonly string[];
    readonly requestKinds: readonly ["initial-auth", "boundary-recheck", "release-output"];
    readonly sequenceRule: "zero-based-contiguous-one-request-one-response-exact-copy-no-unsolicited-response";
    readonly boundaryCountRule: "native-validates-exact-check-or-packet-subroute-roster-success-complete-release-last-failure-strict-nonrelease-prefix";
    readonly boundaryIdRule: "packet-protocol-launcher-boundary-contract-exact-kind-and-boundary-id-stage-install-distinct-path-bound";
    readonly launcherVersion: "phase10-c0v-s6-native-launcher-v1";
    readonly directionRule: "node-stdout-request-launcher-os-nonblocking-inherited-stdin-response-per-boundary-control-open-until-release-eof";
    readonly handleInheritanceRule: "windows-startupinfoex-exact-handle-list-posix-dup2-close-all-no-env-or-argv-handles";
    readonly responseReadHandleRule: "launcher-to-node-response-read-end-os-nonblocking-windows-createpipe-checked-setnamedpipehandlestate-pipe-nowait-before-createprocess-posix-checked-fcntl-o-nonblock-before-exec";
    readonly responseReadObservationRule: "node-polls-parent-hrtime-only-eagain-or-ewouldblock-means-no-bytes-zero-means-eof-all-other-read-errors-fail-stop";
    readonly preRequestQueueRule: "before-every-request-reject-any-queued-unsolicited-byte-or-eof-eagain-or-ewouldblock-required";
    readonly nonreleaseResponseRule: "after-canonical-nonrelease-response-drain-currently-queued-bytes-reject-if-nonempty-or-eof-later-bytes-rejected-before-next-boundary";
    readonly releaseResponseRule: "release-success-requires-canonical-response-then-exact-eof-no-intervening-byte-under-same-request-write-to-response-and-eof-deadline";
    readonly parentBindingRule: "response-process-ppid-equals-live-launcher-pid-and-private-pipe-peer";
    readonly launcherImageRule: "launcher-self-opens-canonical-image-before-child-and-every-response-requires-initial-equality-reports-current-identity-parent-reopens-rehashes-and-compares-resolved-catalogue";
    readonly livenessRule: "fresh-per-request-challenge-before-authorizing-preflight-stage-install-terminal-candidate-each-selected-stage-install-and-packet-package-cleanup-launcher-live-parent-until-release";
    readonly outputProxyRule: "control-requests-consumed-no-executor-output-before-accepted-release-response-and-exact-eof-then-raw-proxy-no-further-frame-parsing";
    readonly proxyBufferBytesMaximum: 65536;
    readonly proxyBufferRule: "post-auth-fixed-size-read-write-drain-before-next-read-no-aggregate-launcher-buffering";
    readonly failureRule: "missing-extra-timeout-pid-image-peer-queued-byte-premature-eof-release-intervening-byte-read-error-or-roster-drift-fail-stop-no-authority-strict-prefix-no-release";
  }>;
  readonly entrypointRule: "parent-channel-before-arguments-or-authority-worker-only-through-authenticated-parent-transport";
  readonly argumentRule: Readonly<{
    readonly launcherExecutablePath: "runner/native/phase10-c0v-s6-launcher-win32-x64.exe";
    readonly childNodeExecutablePath: "C:/Users/biao3/AppData/Local/nvm/v24.13.1/node.exe";
    readonly childEntrypointPath: "runner/src/phase10-c0v-s6-executor.ts";
    readonly cwd: "G:/Code Files/snowflake-phase10-evidence";
    readonly shell: false;
    readonly vectorFieldOrder: readonly string[];
    readonly vectors: readonly Phase10C0VS6RuntimeLauncherArgumentVector[];
  }>;
  readonly directNodeRule: "direct-node-entrypoints-never-authorize-run-or-evidence-marker-alone-insufficient";
  readonly buildContract: null;
}
...
export interface Phase10C0VS6RuntimeLoaderContract {
  ...
  readonly workerEnvironmentRule: "parent-materializes-exact-runtime-launcher-clean-environment-worker-independently-exact-compares-complete-environment-no-ambient-clone";
  readonly preflightRecordingRule: "frozen-code-rejection-no-ambient-environment-values-serialized";
  readonly entryObservationScopeRule: "visible-at-entry-only-self-erasing-preloads-not-excluded";
  readonly implementationFreezeBlockerRule: "external-registered-pre-node-launcher-required-before-implementation-freeze";
}
...
export interface Phase10C0VS6PacketCatalogue {
  readonly schema: typeof PHASE10_C0V_S6_PACKET_CATALOGUE_SCHEMA;
  readonly catalogueId: string;
  readonly matrixId: typeof PHASE10_C0V_S6_MATRIX_ID;
  readonly packageLockPath: "out/phase10-execution-v2/locks/package.lock";
  readonly packageLockRule: "acquire-before-packet-lock-and-any-observation-stale-halts-all-s6";
  readonly runtimeLauncherContract: Phase10C0VS6RuntimeLauncherContract;
...
function parseResources(value: StrictJson, label: string): Phase10C0VS6PacketResources {
  const row = object(value, label);
  ...
  if (perExecutableControlInvocationWallHoursMaximum !== 4 || packageProcessHoursMaximum !== 24 ||
    ...
    packageStorageBaselineBytes !== PHASE10_C0V_S6_PACKAGE_STORAGE_BASELINE_BYTES ||
    packageStorageBaselineArtifacts.length !== PHASE10_C0V_S6_PACKAGE_STORAGE_BASELINE.length ||
    packageStorageBaselineArtifacts.some((entry, index) =>
      !sameArtifactIdentity(entry, PHASE10_C0V_S6_PACKAGE_STORAGE_BASELINE[index]!))) {
  ...
  return Object.freeze({
    ...
    packageStorageBaselineBytes: packageStorageBaselineBytes as 1629577,
...
function parseAncestryAuthority(value: StrictJson, label: string): Phase10C0VS6AncestryAuthority {
  const row = object(value, label);
  exactKeys(row, [
  ...
  return Object.freeze({
    ...
    implementationFreezeRule: literal(row.implementationFreezeRule, "common-first-introduction-commit-of-execution-v2-authority-and-callable-closure", `${label}.implementationFreezeRule`),
...
function parsePreflightObservedContract(
  ...
  return Object.freeze({
    ...
    packetCataloguePath: literal(row.packetCataloguePath, "research/phase10-execution-v2/packet-catalogue.json", `${label}.packetCataloguePath`),
    cleanWorktreeRequired: true,
...
function parseLauncherBoundaryRequest(
  value: StrictJson,
  label: string,
): Phase10C0VS6LauncherBoundaryRequestAuthority {
  const row = object(value, label);
  exactKeys(row, ["kind", "boundaryId"], label);
  return Object.freeze({
    kind: enumValue(
      row.kind,
      ["initial-auth", "boundary-recheck", "release-output"] as const,
      `${label}.kind`,
    ),
    boundaryId: stringValue(row.boundaryId, `${label}.boundaryId`),
  });
}

function parseLauncherBoundaryContract(
  value: StrictJson,
  label: string,
): Phase10C0VS6LauncherBoundaryContract {
  const row = object(value, label);
  exactKeys(row, [
    "schema", "requestExactFields", "checkRequests", "runRosters", "derivationRule", "failureRule",
  ], label);
  exactStringArray(
    row.requestExactFields,
    ["kind", "boundaryId"],
    `${label}.requestExactFields`,
  );
  const checkRequests = arrayValue(row.checkRequests, `${label}.checkRequests`).map((entry, index) =>
    parseLauncherBoundaryRequest(entry, `${label}.checkRequests[${index}]`));
  const runRosters = arrayValue(row.runRosters, `${label}.runRosters`).map((entry, index) => {
    const rosterLabel = `${label}.runRosters[${index}]`;
    const roster = object(entry, rosterLabel);
    exactKeys(roster, ["subrouteId", "requests"], rosterLabel);
    return Object.freeze({
      subrouteId: stringValue(roster.subrouteId, `${rosterLabel}.subrouteId`),
      requests: Object.freeze(arrayValue(roster.requests, `${rosterLabel}.requests`).map(
        (request, requestIndex) => parseLauncherBoundaryRequest(
          request,
          `${rosterLabel}.requests[${requestIndex}]`,
        ),
      )),
    });
  });
  return Object.freeze({
    schema: literal(
      row.schema,
      "phase10-c0v-s6-launcher-boundary-contract-v1",
      `${label}.schema`,
    ),
    requestExactFields: Object.freeze(["kind", "boundaryId"] as const),
    checkRequests: Object.freeze(checkRequests),
    runRosters: Object.freeze(runRosters),
    derivationRule: literal(
      row.derivationRule,
      "common-preflight-stage-install-then-terminal-candidate-then-selected-path-ordered-stage-install-then-optional-verification-stage-install-then-terminal-stage-install-then-path-bound-cleanup-and-release",
      `${label}.derivationRule`,
    ),
    failureRule: literal(
      row.failureRule,
      "failure-is-strict-nonrelease-prefix-success-is-complete-roster-with-release-last",
      `${label}.failureRule`,
    ),
  });
}

const PHASE10_C0V_S6_CHECK_LAUNCHER_BOUNDARY_REQUESTS = Object.freeze([
  Object.freeze({ kind: "initial-auth" as const, boundaryId: "entry-before-arguments" }),
  Object.freeze({ kind: "release-output" as const, boundaryId: "release-output" }),
]);

function phase10C0VS6SameLauncherBoundaryRequests(
  actual: readonly Phase10C0VS6LauncherBoundaryRequestAuthority[],
  expected: readonly Phase10C0VS6LauncherBoundaryRequestAuthority[],
): boolean {
  return actual.length === expected.length && actual.every((entry, index) => {
    const expectedEntry = expected[index];
    return expectedEntry !== undefined && entry.kind === expectedEntry.kind &&
      entry.boundaryId === expectedEntry.boundaryId;
  });
}

function phase10C0VS6ExpectedLauncherRunBoundaryRequests(
  registeredAttemptId: string,
  paths: Phase10C0VS6PacketProtocol["paths"],
  candidateFilenames: readonly string[],
  subroute: Phase10C0VS6PacketTerminalSubrouteAuthority,
  verificationFilename: string,
): readonly Phase10C0VS6LauncherBoundaryRequestAuthority[] {
  const transitionFor = (finalPath: string): Phase10C0VS6PublicationStagingPath => {
    const rows = paths.publicationStagingPaths.filter((entry) => entry.finalPath === finalPath);
    if (rows.length !== 1) fail(finalPath, "must resolve one launcher publication transition");
    return rows[0]!;
  };
  const publicationPair = (finalPath: string): readonly Phase10C0VS6LauncherBoundaryRequestAuthority[] => {
    const transition = transitionFor(finalPath);
    return Object.freeze([
      Object.freeze({
        kind: "boundary-recheck" as const,
        boundaryId: `publication-stage:${transition.stagingPath}`,
      }),
      Object.freeze({
        kind: "boundary-recheck" as const,
        boundaryId: `publication-install:${transition.finalPath}`,
      }),
    ]);
  };
  const candidateFinalPaths = candidateFilenames.map((filename) => {
    const matches = paths.allowedPublicationPaths.filter((path) => path.split("/").at(-1) === filename);
    if (matches.length !== 1) fail(filename, "must resolve one launcher candidate publication path");
    return matches[0]!;
  }).sort((left, right) => left < right ? -1 : left > right ? 1 : 0);
  if (new Set(candidateFinalPaths).size !== candidateFinalPaths.length) {
    fail(subroute.subrouteId, "launcher candidate publication paths repeat");
  }
  const verificationPaths = paths.allowedPublicationPaths.filter((path) =>
    path.endsWith(`/${verificationFilename}`));
  if (verificationPaths.length !== 1) fail("launcher boundary authority", "lacks one verification path");
  const verificationOutputIds = subroute.requiredOutputIds.filter((outputId) =>
    outputId.endsWith("-verification"));
  if (verificationOutputIds.length > 1) fail(subroute.subrouteId, "repeats verification output authority");

  const requests: Phase10C0VS6LauncherBoundaryRequestAuthority[] = [
    Object.freeze({ kind: "initial-auth", boundaryId: "entry-before-arguments" }),
    ...publicationPair(paths.preflightReceiptPath),
    Object.freeze({
      kind: "boundary-recheck",
      boundaryId: `terminal-candidate:${paths.attemptRoot}/${registeredAttemptId}/terminal-success-candidate.json`,
    }),
  ];
  for (const finalPath of candidateFinalPaths) requests.push(...publicationPair(finalPath));
  if (verificationOutputIds.length === 1) requests.push(...publicationPair(verificationPaths[0]!));
  requests.push(
    ...publicationPair(paths.terminalReceiptPath),
    Object.freeze({
      kind: "boundary-recheck",
      boundaryId: `cleanup-packet-lock:${paths.lockPath}`,
    }),
    Object.freeze({
      kind: "boundary-recheck",
      boundaryId: `cleanup-package-lock:${paths.packageLockPath}`,
    }),
    Object.freeze({ kind: "release-output", boundaryId: "release-output" }),
  );
  const ids = requests.map((entry) => entry.boundaryId);
  if (new Set(ids).size !== ids.length) fail(subroute.subrouteId, "launcher boundary IDs repeat");
  return Object.freeze(requests);
}

export function phase10C0VS6LauncherBoundaryRequests(
  protocol: Phase10C0VS6PacketProtocol,
  mode: "check" | "run",
  selectedSubrouteId: string | null,
): readonly Phase10C0VS6LauncherBoundaryRequestAuthority[] {
  if (mode === "check") {
    if (selectedSubrouteId !== null) fail("check launcher boundary authority", "cannot select a run subroute");
    return protocol.launcherBoundaryContract.checkRequests;
  }
  if (selectedSubrouteId === null) fail("run launcher boundary authority", "requires the selected subroute");
  const rosters = protocol.launcherBoundaryContract.runRosters.filter((entry) =>
    entry.subrouteId === selectedSubrouteId);
  if (rosters.length !== 1) fail("run launcher boundary authority", "does not resolve one selected subroute");
  return rosters[0]!.requests;
}

export function parsePhase10C0VS6PacketProtocol(value: unknown): Phase10C0VS6PacketProtocol {
  const label = "packet protocol";
  const row = object(value, label);
  exactKeys(row, ["schema", "protocolId", "matrixId", "packetId", "registryId", "registeredAttemptId", "executionMode", "bindings", "selectedRouteId", "s5ArtifactDisposition", "registeredOutputIds", "registeredCheckIds", "registeredNegativeControlIds", "boundDependencyPacketIds", "dependencyArtifactContracts", "commandTemplates", "launcherBoundaryContract", "paths", "candidateFilenameRosters", "internalArtifactRosters", "verification", "allowedCleanTerminalClasses", "terminalSubroutes", "resources", "ancestryAuthority", "preObservationProductionClosure", "preflightObservedContract", "workerInvocationContract", "workerProgressContract", "exitStatusContract", "freezeEvaluationContract", "causeEvaluationContract", "terminalCandidateContract", "terminalReceiptContract", "executionRecordTuples", "executableInvocationRosters", "verificationInvocationRoster", "verificationRegisteredCapBindings", "resourceObservationPointRosters", "registeredCapBindings", "classificationConditions", "classificationProjectionRosters", "radialBinaryLayout", "radialProducerSummary", "controlOperators", "aggregateNegativeControlContract", "claimBoundary"], label);
  const bindings = object(row.bindings, `${label}.bindings`);
  exactKeys(bindings, ["matrix", "packetCatalogue", "callableRegistry", "predecessorSchemaRegistry", "predecessorSchemaContracts", "successorSchemaRegistry", "successorSchemaContracts", "scienceProtocol", "referenceOrRefusal", "originalApEvidence"], `${label}.bindings`);
  ...
  const launcherBoundaryContract = parseLauncherBoundaryContract(
    row.launcherBoundaryContract,
    `${label}.launcherBoundaryContract`,
  );
  ...
  if (protocolId !== `phase10-${packetId}-execution-v2-v1` ||
    registryId !== `phase10-${packetId}-execution-v2-callables-v1` ||
    registeredAttemptId !== `${packetId}-20260822-v1`) {
    fail(label, "protocolId, registryId, or registeredAttemptId differs from exact packet identity");
  }
  const commandBase = `--packet ${packetId} --protocol research/phase10-execution-v2/packets/${packetId}/protocol.json --attempt ${registeredAttemptId}`;
  ...
  const expectedAttemptRoot = `out/phase10-execution-v2/attempts/${packetId}`;
  const expectedLockPath = `out/phase10-execution-v2/locks/${packetId}.lock`;
  const expectedPreflightPath = `evidence/phase10-obligation-preflight-v2/packets/${packetId}/preflight.json`;
  const expectedTerminalPath = `evidence/phase10-obligation-preflight-v2/packets/${packetId}/terminal-receipt.json`;
  if (paths.attemptRoot !== expectedAttemptRoot ||
    paths.packageLockPath !== "out/phase10-execution-v2/locks/package.lock" ||
  ...
  const expectedBindingPaths = {
    ...
    packetCatalogue: "research/phase10-execution-v2/packet-catalogue.json",
    callableRegistry: `research/phase10-execution-v2/packets/${packetId}/callable-registry.json`,
  ...
  const resources = parseResources(row.resources, `${label}.resources`);
  ...
  const ancestryAuthority = parseAncestryAuthority(row.ancestryAuthority, `${label}.ancestryAuthority`);
  ...
  const preflightObservedContract = parsePreflightObservedContract(row.preflightObservedContract, `${label}.preflightObservedContract`);
  ...
  const parsedPaths = Object.freeze({
    ...
    packageLockPath: literal(
      paths.packageLockPath,
      "out/phase10-execution-v2/locks/package.lock",
      `${label}.paths.packageLockPath`,
    ),
  ...
  if (!phase10C0VS6SameLauncherBoundaryRequests(
    launcherBoundaryContract.checkRequests,
    PHASE10_C0V_S6_CHECK_LAUNCHER_BOUNDARY_REQUESTS,
  )) {
    fail(`${label}.launcherBoundaryContract.checkRequests`, "differs from exact initial/release check roster");
  }
  if (launcherBoundaryContract.runRosters.length !== terminalSubroutes.length) {
    fail(`${label}.launcherBoundaryContract.runRosters`, "must cover every terminal subroute exactly once");
  }
  for (const [subrouteIndex, subroute] of terminalSubroutes.entries()) {
    const roster = launcherBoundaryContract.runRosters[subrouteIndex];
    if (roster === undefined || roster.subrouteId !== subroute.subrouteId) {
      fail(`${label}.launcherBoundaryContract.runRosters`, "must follow exact terminal-subroute order");
    }
    const candidateFilenames = candidateFilenameRosters[subroute.subrouteId];
    if (candidateFilenames === undefined) {
      fail(`${label}.launcherBoundaryContract.runRosters.${subroute.subrouteId}`, "lacks candidate publication authority");
    }
    const expectedRequests = phase10C0VS6ExpectedLauncherRunBoundaryRequests(
      registeredAttemptId,
      parsedPaths,
      candidateFilenames,
      subroute,
    ...
    if (!phase10C0VS6SameLauncherBoundaryRequests(roster.requests, expectedRequests)) {
      fail(
        `${label}.launcherBoundaryContract.runRosters.${subroute.subrouteId}`,
        "differs from exact outcome-selected publication, cleanup, and release boundary order",
      );
    }
  }
  return Object.freeze({
    schema: literal(row.schema, PHASE10_C0V_S6_PACKET_PROTOCOL_SCHEMA, `${label}.schema`),
    protocolId,
    matrixId: literal(row.matrixId, PHASE10_C0V_S6_MATRIX_ID, `${label}.matrixId`),
    packetId,
    registryId,
...
export function parsePhase10C0VS6RetainedPreflight(
  ...
  const expectedRegistryPath = `research/phase10-execution-v2/packets/${protocol.packetId}/callable-registry.json`;
...
export function parsePhase10C0VS6PacketCatalogue(value: unknown): Phase10C0VS6PacketCatalogue {
  ...
  exactKeys(row, [
    ...
    "runtimeLauncherContract", "runtimeEntrypoints", "runtimeLoaderContract",
    "workerTransportContract", "packets",
  ], label);
  ...
  const launcherRow = object(row.runtimeLauncherContract, `${label}.runtimeLauncherContract`);
  exactKeys(launcherRow, [
    "schema", "launcherId", "state", "sourcePath", "executable", "repositoryRoot",
    "nodeExecutable", "gitExecutable", "ambientInspectionRule", "cleanEnvironment",
    "launcherChannelContract", "entrypointRule", "argumentRule", "directNodeRule",
    "buildContract",
  ], `${label}.runtimeLauncherContract`);
  const launcherExecutableRow = object(
    launcherRow.executable,
    `${label}.runtimeLauncherContract.executable`,
  );
  exactKeys(launcherExecutableRow, [
    "platform", "arch", "path", "resolution", "identity",
  ], `${label}.runtimeLauncherContract.executable`);
  if (launcherExecutableRow.identity !== null) {
    fail(`${label}.runtimeLauncherContract.executable.identity`,
      "must remain null while launcher state is design-frozen-source-absent");
  }
  const launcherExecutable = Object.freeze({
    platform: literal(
      launcherExecutableRow.platform,
      "win32",
      `${label}.runtimeLauncherContract.executable.platform`,
    ),
    arch: literal(
      launcherExecutableRow.arch,
      "x64",
      `${label}.runtimeLauncherContract.executable.arch`,
    ),
    path: literal(
      launcherExecutableRow.path,
      "runner/native/phase10-c0v-s6-launcher-win32-x64.exe",
      `${label}.runtimeLauncherContract.executable.path`,
    ),
    resolution: literal(
      launcherExecutableRow.resolution,
      "planned",
      `${label}.runtimeLauncherContract.executable.resolution`,
    ),
    identity: null,
  });
  const nodeExecutableRow = object(
    launcherRow.nodeExecutable,
    `${label}.runtimeLauncherContract.nodeExecutable`,
  );
  exactKeys(nodeExecutableRow, [
    "platform", "arch", "version", "path", "byteLength", "sha256",
  ], `${label}.runtimeLauncherContract.nodeExecutable`);
  const nodeExecutable = Object.freeze({
    platform: literal(
      nodeExecutableRow.platform,
      "win32",
      `${label}.runtimeLauncherContract.nodeExecutable.platform`,
    ),
    arch: literal(
      nodeExecutableRow.arch,
      "x64",
      `${label}.runtimeLauncherContract.nodeExecutable.arch`,
    ),
    version: literal(
      nodeExecutableRow.version,
      "v24.13.1",
      `${label}.runtimeLauncherContract.nodeExecutable.version`,
    ),
    path: literal(
      nodeExecutableRow.path,
      "C:/Users/biao3/AppData/Local/nvm/v24.13.1/node.exe",
      `${label}.runtimeLauncherContract.nodeExecutable.path`,
    ),
    byteLength: safeInteger(
      nodeExecutableRow.byteLength,
      `${label}.runtimeLauncherContract.nodeExecutable.byteLength`,
      1,
    ),
    sha256: stringValue(
      nodeExecutableRow.sha256,
      `${label}.runtimeLauncherContract.nodeExecutable.sha256`,
    ),
  });
  if (nodeExecutable.byteLength !== 91_406_496 ||
    nodeExecutable.sha256 !== "e3be0545990c90995d7bf3a7af5d64af1f2e0fc1bbd9b79c27f7abc1e9676e50") {
    fail(`${label}.runtimeLauncherContract.nodeExecutable`, "differs from exact host Node identity");
  }
  const gitExecutableRow = object(
    launcherRow.gitExecutable,
    `${label}.runtimeLauncherContract.gitExecutable`,
  );
  exactKeys(gitExecutableRow, [
    "platform", "arch", "version", "path", "byteLength", "sha256", "linkCount",
    "linkPolicy",
  ], `${label}.runtimeLauncherContract.gitExecutable`);
  const gitExecutable = Object.freeze({
    platform: literal(
      gitExecutableRow.platform,
      "win32",
      `${label}.runtimeLauncherContract.gitExecutable.platform`,
    ),
    arch: literal(
      gitExecutableRow.arch,
      "x64",
      `${label}.runtimeLauncherContract.gitExecutable.arch`,
    ),
    version: literal(
      gitExecutableRow.version,
      "2.35.1.windows.2",
      `${label}.runtimeLauncherContract.gitExecutable.version`,
    ),
    path: literal(
      gitExecutableRow.path,
      "C:/Program Files/Git/cmd/git.exe",
      `${label}.runtimeLauncherContract.gitExecutable.path`,
    ),
    byteLength: safeInteger(
      gitExecutableRow.byteLength,
      `${label}.runtimeLauncherContract.gitExecutable.byteLength`,
      1,
    ),
    sha256: stringValue(
      gitExecutableRow.sha256,
      `${label}.runtimeLauncherContract.gitExecutable.sha256`,
    ),
    linkCount: safeInteger(
      gitExecutableRow.linkCount,
      `${label}.runtimeLauncherContract.gitExecutable.linkCount`,
      1,
    ),
    linkPolicy: literal(
      gitExecutableRow.linkPolicy,
      "host-provenance-exact-path-and-bytes-repository-single-link-rule-not-applied",
      `${label}.runtimeLauncherContract.gitExecutable.linkPolicy`,
    ),
  });
  if (gitExecutable.byteLength !== 45_584 || gitExecutable.linkCount !== 2 ||
    gitExecutable.sha256 !== "2295eb8e7e38e4fe504c38fe18ef11b86d2d3fb9d32d1b58c4244621d9e7babd") {
    fail(`${label}.runtimeLauncherContract.gitExecutable`, "differs from exact host Git identity");
  }
  const expectedCleanEnvironment = Object.freeze([
    ...
    Object.freeze({
      key: "PHASE10_C0V_S6_LAUNCHER_VERSION",
      value: "phase10-c0v-s6-native-launcher-v1",
    }),
    Object.freeze({ key: "SYSTEMROOT", value: "C:\\WINDOWS" }),
  ]);
  const cleanEnvironment = arrayValue(
    launcherRow.cleanEnvironment,
    `${label}.runtimeLauncherContract.cleanEnvironment`,
  ).map((entry, index) => {
    const environmentRow = object(
      entry,
      `${label}.runtimeLauncherContract.cleanEnvironment[${index}]`,
    );
    exactKeys(environmentRow, ["key", "value"],
      `${label}.runtimeLauncherContract.cleanEnvironment[${index}]`);
    return Object.freeze({
      key: stringValue(environmentRow.key,
        `${label}.runtimeLauncherContract.cleanEnvironment[${index}].key`),
      value: stringValue(environmentRow.value,
        `${label}.runtimeLauncherContract.cleanEnvironment[${index}].value`),
    });
  });
  if (cleanEnvironment.length !== expectedCleanEnvironment.length ||
    cleanEnvironment.some((entry, index) => entry.key !== expectedCleanEnvironment[index]!.key ||
      entry.value !== expectedCleanEnvironment[index]!.value)) {
    fail(`${label}.runtimeLauncherContract.cleanEnvironment`, "differs from exact clean child block");
  }
  const channelRow = object(
    launcherRow.launcherChannelContract,
    `${label}.runtimeLauncherContract.launcherChannelContract`,
  );
  exactKeys(channelRow, [
    "schema", "transport", "maximumFrameBytes", "challengeBytes", "challengeEncoding",
    "challengeSource", "authenticationTimeoutMilliseconds", "authenticationTimingRule",
    "requestSchema", "requestDomain", "requestExactFields",
    "responseSchema", "responseExactFields", "requestKinds", "sequenceRule",
    "boundaryCountRule", "boundaryIdRule", "launcherVersion", "directionRule",
    "handleInheritanceRule", "responseReadHandleRule", "responseReadObservationRule",
    "preRequestQueueRule", "nonreleaseResponseRule", "releaseResponseRule",
    "parentBindingRule", "launcherImageRule", "livenessRule",
    "outputProxyRule", "proxyBufferBytesMaximum", "proxyBufferRule", "failureRule",
  ], `${label}.runtimeLauncherContract.launcherChannelContract`);
  const launcherChannelContract = Object.freeze({
    schema: literal(channelRow.schema, "phase10-c0v-s6-launcher-channel-contract-v1",
      `${label}.runtimeLauncherContract.launcherChannelContract.schema`),
    transport: literal(
      channelRow.transport,
      "private-inherited-bidirectional-anonymous-pipes-first-frame-auth-v1",
      `${label}.runtimeLauncherContract.launcherChannelContract.transport`,
    ),
    maximumFrameBytes: safeInteger(channelRow.maximumFrameBytes,
      `${label}.runtimeLauncherContract.launcherChannelContract.maximumFrameBytes`, 1),
    challengeBytes: safeInteger(channelRow.challengeBytes,
      `${label}.runtimeLauncherContract.launcherChannelContract.challengeBytes`, 1),
    challengeEncoding: literal(channelRow.challengeEncoding, "lowercase-hex-exact-64",
      `${label}.runtimeLauncherContract.launcherChannelContract.challengeEncoding`),
    challengeSource: literal(channelRow.challengeSource, "node-crypto-randombytes-fresh-per-request",
      `${label}.runtimeLauncherContract.launcherChannelContract.challengeSource`),
    authenticationTimeoutMilliseconds: safeInteger(
      channelRow.authenticationTimeoutMilliseconds,
      `${label}.runtimeLauncherContract.launcherChannelContract.authenticationTimeoutMilliseconds`,
      1,
    ) as 30000,
    authenticationTimingRule: literal(
      channelRow.authenticationTimingRule,
      "launcher-monotonic-successful-child-create-to-complete-request-node-parent-hrtime-complete-request-write-to-complete-response-and-for-release-exact-eof-under-same-deadline-equality-accepted-plus-one-millisecond-fail-stop",
      `${label}.runtimeLauncherContract.launcherChannelContract.authenticationTimingRule`,
    ),
    requestSchema: literal(channelRow.requestSchema, "phase10-c0v-s6-launcher-challenge-v1",
      `${label}.runtimeLauncherContract.launcherChannelContract.requestSchema`),
    requestDomain: literal(channelRow.requestDomain, "phase10-c0v-s6-native-launcher-auth-v1",
      `${label}.runtimeLauncherContract.launcherChannelContract.requestDomain`),
    requestExactFields: exactStringArray(channelRow.requestExactFields,
      ["schema", "domain", "sequence", "kind", "boundaryId", "childPid", "challenge"],
      `${label}.runtimeLauncherContract.launcherChannelContract.requestExactFields`),
    responseSchema: literal(channelRow.responseSchema, "phase10-c0v-s6-launcher-response-v1",
      `${label}.runtimeLauncherContract.launcherChannelContract.responseSchema`),
    responseExactFields: exactStringArray(channelRow.responseExactFields,
      ["schema", "domain", "sequence", "kind", "boundaryId", "launcherVersion",
        "launcherPid", "childPid", "challenge", "launcherExecutable"],
      `${label}.runtimeLauncherContract.launcherChannelContract.responseExactFields`),
    requestKinds: exactStringArray(
      channelRow.requestKinds,
      ["initial-auth", "boundary-recheck", "release-output"],
      `${label}.runtimeLauncherContract.launcherChannelContract.requestKinds`,
    ) as readonly ["initial-auth", "boundary-recheck", "release-output"],
    sequenceRule: literal(
      channelRow.sequenceRule,
      "zero-based-contiguous-one-request-one-response-exact-copy-no-unsolicited-response",
      `${label}.runtimeLauncherContract.launcherChannelContract.sequenceRule`,
    ),
    boundaryCountRule: literal(
      channelRow.boundaryCountRule,
      "native-validates-exact-check-or-packet-subroute-roster-success-complete-release-last-failure-strict-nonrelease-prefix",
      `${label}.runtimeLauncherContract.launcherChannelContract.boundaryCountRule`,
    ),
    boundaryIdRule: literal(
      channelRow.boundaryIdRule,
      "packet-protocol-launcher-boundary-contract-exact-kind-and-boundary-id-stage-install-distinct-path-bound",
      `${label}.runtimeLauncherContract.launcherChannelContract.boundaryIdRule`,
    ),
    launcherVersion: literal(channelRow.launcherVersion, "phase10-c0v-s6-native-launcher-v1",
      `${label}.runtimeLauncherContract.launcherChannelContract.launcherVersion`),
    directionRule: literal(
      channelRow.directionRule,
      "node-stdout-request-launcher-os-nonblocking-inherited-stdin-response-per-boundary-control-open-until-release-eof",
      `${label}.runtimeLauncherContract.launcherChannelContract.directionRule`,
    ),
    handleInheritanceRule: literal(
      channelRow.handleInheritanceRule,
      "windows-startupinfoex-exact-handle-list-posix-dup2-close-all-no-env-or-argv-handles",
      `${label}.runtimeLauncherContract.launcherChannelContract.handleInheritanceRule`,
    ),
    responseReadHandleRule: literal(
      channelRow.responseReadHandleRule,
      ...
      `${label}.runtimeLauncherContract.launcherChannelContract.responseReadHandleRule`,
    ),
    responseReadObservationRule: literal(
      channelRow.responseReadObservationRule,
      "node-polls-parent-hrtime-only-eagain-or-ewouldblock-means-no-bytes-zero-means-eof-all-other-read-errors-fail-stop",
      `${label}.runtimeLauncherContract.launcherChannelContract.responseReadObservationRule`,
    ),
    preRequestQueueRule: literal(
      channelRow.preRequestQueueRule,
      "before-every-request-reject-any-queued-unsolicited-byte-or-eof-eagain-or-ewouldblock-required",
      `${label}.runtimeLauncherContract.launcherChannelContract.preRequestQueueRule`,
    ),
    nonreleaseResponseRule: literal(
      channelRow.nonreleaseResponseRule,
      ...
      `${label}.runtimeLauncherContract.launcherChannelContract.nonreleaseResponseRule`,
    ),
    releaseResponseRule: literal(
      channelRow.releaseResponseRule,
      ...
      `${label}.runtimeLauncherContract.launcherChannelContract.releaseResponseRule`,
    ),
    parentBindingRule: literal(
      channelRow.parentBindingRule,
      "response-process-ppid-equals-live-launcher-pid-and-private-pipe-peer",
      `${label}.runtimeLauncherContract.launcherChannelContract.parentBindingRule`,
    ),
    launcherImageRule: literal(
      channelRow.launcherImageRule,
      ...
      `${label}.runtimeLauncherContract.launcherChannelContract.launcherImageRule`,
    ),
    livenessRule: literal(
      channelRow.livenessRule,
      "fresh-per-request-challenge-before-authorizing-preflight-stage-install-terminal-candidate-each-selected-stage-install-and-packet-package-cleanup-launcher-live-parent-until-release",
      `${label}.runtimeLauncherContract.launcherChannelContract.livenessRule`,
    ),
    outputProxyRule: literal(
      channelRow.outputProxyRule,
      ...
      `${label}.runtimeLauncherContract.launcherChannelContract.outputProxyRule`,
    ),
    proxyBufferBytesMaximum: safeInteger(
      channelRow.proxyBufferBytesMaximum,
      `${label}.runtimeLauncherContract.launcherChannelContract.proxyBufferBytesMaximum`,
      1,
    ) as 65536,
    proxyBufferRule: literal(
      channelRow.proxyBufferRule,
      "post-auth-fixed-size-read-write-drain-before-next-read-no-aggregate-launcher-buffering",
      `${label}.runtimeLauncherContract.launcherChannelContract.proxyBufferRule`,
    ),
    failureRule: literal(
      channelRow.failureRule,
      "missing-extra-timeout-pid-image-peer-queued-byte-premature-eof-release-intervening-byte-read-error-or-roster-drift-fail-stop-no-authority-strict-prefix-no-release",
      `${label}.runtimeLauncherContract.launcherChannelContract.failureRule`,
    ),
  });
  if (launcherChannelContract.maximumFrameBytes !== 4_096 ||
    launcherChannelContract.challengeBytes !== 32 ||
    launcherChannelContract.authenticationTimeoutMilliseconds !== 30_000 ||
    launcherChannelContract.proxyBufferBytesMaximum !== 65_536) {
    fail(`${label}.runtimeLauncherContract.launcherChannelContract`,
      "frame/challenge/timing/proxy bounds differ from exact design");
  }
  const argumentRuleRow = object(
    launcherRow.argumentRule,
    `${label}.runtimeLauncherContract.argumentRule`,
  );
  exactKeys(argumentRuleRow, [
    "launcherExecutablePath", "childNodeExecutablePath", "childEntrypointPath", "cwd", "shell",
    "vectorFieldOrder", "vectors",
  ], `${label}.runtimeLauncherContract.argumentRule`);
  const vectors = arrayValue(
    argumentRuleRow.vectors,
    `${label}.runtimeLauncherContract.argumentRule.vectors`,
  ).map((entry, index): Phase10C0VS6RuntimeLauncherArgumentVector => {
    const vector = object(entry, `${label}.runtimeLauncherContract.argumentRule.vectors[${index}]`);
    exactKeys(vector, [
      "mode", "packetId", "protocolPath", "attemptId", "launcherArguments", "childArguments",
    ], `${label}.runtimeLauncherContract.argumentRule.vectors[${index}]`);
    return Object.freeze({
      mode: enumValue(vector.mode, ["check", "run"] as const,
        `${label}.runtimeLauncherContract.argumentRule.vectors[${index}].mode`),
      packetId: parsePacketId(vector.packetId,
        `${label}.runtimeLauncherContract.argumentRule.vectors[${index}].packetId`),
      protocolPath: safePath(vector.protocolPath,
        `${label}.runtimeLauncherContract.argumentRule.vectors[${index}].protocolPath`),
      attemptId: stringValue(vector.attemptId,
        `${label}.runtimeLauncherContract.argumentRule.vectors[${index}].attemptId`),
      launcherArguments: exactStringArray(vector.launcherArguments,
        arrayValue(vector.launcherArguments,
          `${label}.runtimeLauncherContract.argumentRule.vectors[${index}].launcherArguments`)
          .map((value, argumentIndex) => stringValue(value,
            `${label}.runtimeLauncherContract.argumentRule.vectors[${index}].launcherArguments[${argumentIndex}]`)),
        `${label}.runtimeLauncherContract.argumentRule.vectors[${index}].launcherArguments`),
      childArguments: exactStringArray(vector.childArguments,
        arrayValue(vector.childArguments,
          `${label}.runtimeLauncherContract.argumentRule.vectors[${index}].childArguments`)
          .map((value, argumentIndex) => stringValue(value,
            `${label}.runtimeLauncherContract.argumentRule.vectors[${index}].childArguments[${argumentIndex}]`)),
        `${label}.runtimeLauncherContract.argumentRule.vectors[${index}].childArguments`),
    });
  });
  const expectedVectors = PHASE10_C0V_S6_PACKET_IDS.flatMap((packetId) =>
    (["check", "run"] as const).map((mode): Phase10C0VS6RuntimeLauncherArgumentVector => {
      const protocolPath = `research/phase10-execution-v2/packets/${packetId}/protocol.json`;
      const attemptId = `${packetId}-20260822-v1`;
      const suffix = [mode, "--packet", packetId, "--protocol", protocolPath, "--attempt", attemptId];
      return Object.freeze({
        mode,
        packetId,
        protocolPath,
        attemptId,
        launcherArguments: Object.freeze(suffix),
  ...
  if (vectors.length !== expectedVectors.length || vectors.some((entry, index) => {
    const expected = expectedVectors[index]!;
    return entry.mode !== expected.mode || entry.packetId !== expected.packetId ||
      entry.protocolPath !== expected.protocolPath || entry.attemptId !== expected.attemptId ||
      entry.launcherArguments.length !== expected.launcherArguments.length ||
      entry.launcherArguments.some((argument, argumentIndex) =>
        argument !== expected.launcherArguments[argumentIndex]) ||
      entry.childArguments.length !== expected.childArguments.length ||
      entry.childArguments.some((argument, argumentIndex) =>
        argument !== expected.childArguments[argumentIndex]);
  })) {
    fail(`${label}.runtimeLauncherContract.argumentRule.vectors`,
      "must equal exact packet-order check/run launcher and child argv vectors");
  }
  const argumentRule = Object.freeze({
    launcherExecutablePath: literal(
      argumentRuleRow.launcherExecutablePath,
      "runner/native/phase10-c0v-s6-launcher-win32-x64.exe",
      `${label}.runtimeLauncherContract.argumentRule.launcherExecutablePath`,
    ),
    childNodeExecutablePath: literal(
      argumentRuleRow.childNodeExecutablePath,
      "C:/Users/biao3/AppData/Local/nvm/v24.13.1/node.exe",
      `${label}.runtimeLauncherContract.argumentRule.childNodeExecutablePath`,
    ),
    childEntrypointPath: literal(
      argumentRuleRow.childEntrypointPath,
      "runner/src/phase10-c0v-s6-executor.ts",
      `${label}.runtimeLauncherContract.argumentRule.childEntrypointPath`,
    ),
    cwd: literal(argumentRuleRow.cwd, "G:/Code Files/snowflake-phase10-evidence",
      `${label}.runtimeLauncherContract.argumentRule.cwd`),
    shell: (() => {
      const value = booleanValue(argumentRuleRow.shell,
        `${label}.runtimeLauncherContract.argumentRule.shell`);
      if (value) fail(`${label}.runtimeLauncherContract.argumentRule.shell`, "must be false");
      return false as const;
    })(),
    vectorFieldOrder: exactStringArray(argumentRuleRow.vectorFieldOrder,
      ["mode", "packetId", "protocolPath", "attemptId", "launcherArguments", "childArguments"],
      `${label}.runtimeLauncherContract.argumentRule.vectorFieldOrder`),
    vectors: Object.freeze(vectors),
  });
  if (launcherRow.buildContract !== null) {
    fail(`${label}.runtimeLauncherContract.buildContract`,
      "must remain null until source, compiler, binary, and rebuild equality resolve together");
  }
  const runtimeLauncherContract: Phase10C0VS6RuntimeLauncherContract = Object.freeze({
    schema: literal(launcherRow.schema, "phase10-c0v-s6-runtime-launcher-contract-v1",
      `${label}.runtimeLauncherContract.schema`),
    launcherId: literal(launcherRow.launcherId, "phase10-c0v-s6-native-launcher-v1",
      `${label}.runtimeLauncherContract.launcherId`),
    state: literal(launcherRow.state, "design-frozen-source-absent",
      `${label}.runtimeLauncherContract.state`),
    sourcePath: literal(launcherRow.sourcePath, "runner/native/phase10-c0v-s6-launcher.c",
      `${label}.runtimeLauncherContract.sourcePath`),
    executable: launcherExecutable,
    repositoryRoot: literal(launcherRow.repositoryRoot, "G:/Code Files/snowflake-phase10-evidence",
      `${label}.runtimeLauncherContract.repositoryRoot`),
    nodeExecutable,
    gitExecutable,
    ambientInspectionRule: literal(
      launcherRow.ambientInspectionRule,
      "enumerate-before-authority-reject-casefold-duplicates-node-ts-node-and-preexisting-marker-copy-no-ambient-values",
      `${label}.runtimeLauncherContract.ambientInspectionRule`,
    ),
    cleanEnvironment: Object.freeze(cleanEnvironment),
    launcherChannelContract,
    entrypointRule: literal(
      launcherRow.entrypointRule,
      "parent-channel-before-arguments-or-authority-worker-only-through-authenticated-parent-transport",
      `${label}.runtimeLauncherContract.entrypointRule`,
    ),
    argumentRule,
    directNodeRule: literal(
      launcherRow.directNodeRule,
      "direct-node-entrypoints-never-authorize-run-or-evidence-marker-alone-insufficient",
      `${label}.runtimeLauncherContract.directNodeRule`,
    ),
    buildContract: null,
  });
  ...
  exactKeys(runtimeLoader, [
    "schema", "execArgvRule", "forbiddenEnvironmentKeyRule", "workerEnvironmentRule",
    "preflightRecordingRule", "entryObservationScopeRule", "implementationFreezeBlockerRule",
  ...
  const runtimeLoaderContract: Phase10C0VS6RuntimeLoaderContract = Object.freeze({
    ...
    entryObservationScopeRule: literal(
      ...
      "visible-at-entry-only-self-erasing-preloads-not-excluded",
      `${label}.runtimeLoaderContract.entryObservationScopeRule`,
    ),
    implementationFreezeBlockerRule: literal(
      runtimeLoader.implementationFreezeBlockerRule,
      "external-registered-pre-node-launcher-required-before-implementation-freeze",
      `${label}.runtimeLoaderContract.implementationFreezeBlockerRule`,
    ),
  });
  ...
  const verificationByPacket: Readonly<Record<Phase10C0VS6PacketId, readonly [string, string]>> = Object.freeze({
    "a-p-c0v-s6": ["evidence/phase10-obligation-preflight-v2/verification.json", "verification.json"],
    "c0v-moving-produce": ["evidence/phase10-obligation-preflight-v2/packets/c0v-moving-produce/verification.json", "verification.json"],
  ...
  for (const packet of packets) {
    ...
    if (packet.protocolPath !== `research/phase10-execution-v2/packets/${packetId}/protocol.json` ||
      packet.callableRegistryPath !== `research/phase10-execution-v2/packets/${packetId}/callable-registry.json` ||
      packet.attemptRoot !== `out/phase10-execution-v2/attempts/${packetId}` ||
      packet.lockPath !== `out/phase10-execution-v2/locks/${packetId}.lock` ||
      packet.preflightReceiptPath !== `evidence/phase10-obligation-preflight-v2/packets/${packetId}/preflight.json` ||
      packet.terminalReceiptPath !== `evidence/phase10-obligation-preflight-v2/packets/${packetId}/terminal-receipt.json` ||
  ...
  return Object.freeze({
    schema: literal(row.schema, PHASE10_C0V_S6_PACKET_CATALOGUE_SCHEMA, `${label}.schema`),
    catalogueId: literal(
      row.catalogueId,
      "phase10-c0v-s6-execution-v2-packet-paths-v1",
      `${label}.catalogueId`,
    ),
    matrixId: literal(row.matrixId, PHASE10_C0V_S6_MATRIX_ID, `${label}.matrixId`),
    packageLockPath,
