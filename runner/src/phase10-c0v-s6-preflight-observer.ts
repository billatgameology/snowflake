...
function supportedDeepPriorPrefix(packetIds: readonly Phase10C0VS6PacketId[]): boolean {
  return packetIds.length === 0 ||
    packetIds.length === 1 && packetIds[0] === "a-p-c0v-s6" ||
    packetIds.length === 2 && packetIds[0] === "a-p-c0v-s6" &&
      packetIds[1] === "c0v-moving-produce" ||
    packetIds.length === 3 && packetIds[0] === "a-p-c0v-s6" &&
      packetIds[1] === "c0v-moving-produce" && packetIds[2] === "c0v-moving-publish";
}
