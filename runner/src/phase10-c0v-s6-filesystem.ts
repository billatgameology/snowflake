...
import {
  ...
  PHASE10_C0V_S6_RECOVERY_V4_LOCK_ROOT,
  ...
  PHASE10_C0V_S6_RECOVERY_V4_PACKET_LOCK_PATHS,
...
export interface Phase10C0VS6RecoveryPredecessorState {
  readonly authority: Phase10C0VS6RecoveryV4Authority;
  readonly authorityIdentity: Phase10C0VS6ArtifactIdentity;
  readonly authorityBytes: Uint8Array;
  readonly predecessorRecoveryAuthority: Phase10C0VS6RecoveryV3Authority;
  readonly predecessorRecoveryAuthorityIdentity: Phase10C0VS6ArtifactIdentity;
  readonly earlierRecoveryAuthority: Phase10C0VS6RecoveryV2Authority;
...
const PACKAGE_CATALOGUE_PATH = PHASE10_C0V_S6_RECOVERY_V4_PACKET_CATALOGUE_PATH;
const PACKAGE_LOCK_PATH = PHASE10_C0V_S6_RECOVERY_V4_PACKAGE_LOCK_PATH;
const PACKAGE_LOCK_ROOT = PHASE10_C0V_S6_RECOVERY_V4_LOCK_ROOT;
const PACKAGE_LOCK_RULE = PHASE10_C0V_S6_RECOVERY_V4_PACKAGE_LOCK_RULE;
...
const PACKAGE_PACKET_LOCK_AUTHORITY = Object.freeze({
  "a-p-c0v-s6": Object.freeze({
    ...
    protocolPath: "research/phase10-execution-v2/recovery-v4/packets/a-p-c0v-s6/protocol.json",
    lockPath: PHASE10_C0V_S6_RECOVERY_V4_PACKET_LOCK_PATHS["a-p-c0v-s6"],
  ...
  "c0v-moving-produce": Object.freeze({
    ...
    protocolPath: "research/phase10-execution-v2/recovery-v4/packets/c0v-moving-produce/protocol.json",
    lockPath: PHASE10_C0V_S6_RECOVERY_V4_PACKET_LOCK_PATHS["c0v-moving-produce"],
  ...
  "c0v-moving-publish": Object.freeze({
    ...
    protocolPath: "research/phase10-execution-v2/recovery-v4/packets/c0v-moving-publish/protocol.json",
    lockPath: PHASE10_C0V_S6_RECOVERY_V4_PACKET_LOCK_PATHS["c0v-moving-publish"],
  ...
  "c0v-radial-produce": Object.freeze({
    ...
    protocolPath: "research/phase10-execution-v2/recovery-v4/packets/c0v-radial-produce/protocol.json",
    lockPath: PHASE10_C0V_S6_RECOVERY_V4_PACKET_LOCK_PATHS["c0v-radial-produce"],
  ...
  "c0v-radial-publish": Object.freeze({
    ...
    protocolPath: "research/phase10-execution-v2/recovery-v4/packets/c0v-radial-publish/protocol.json",
    lockPath: PHASE10_C0V_S6_RECOVERY_V4_PACKET_LOCK_PATHS["c0v-radial-publish"],
    outerInfrastructureSafetyTimeoutSeconds: 32400,
  }),
  "c0v-static-produce": Object.freeze({
    attemptId: PHASE10_C0V_S6_RECOVERY_V4_ATTEMPT_IDS["c0v-static-produce"],
    protocolPath: "research/phase10-execution-v2/recovery-v4/packets/c0v-static-produce/protocol.json",
    lockPath: PHASE10_C0V_S6_RECOVERY_V4_PACKET_LOCK_PATHS["c0v-static-produce"],
    outerInfrastructureSafetyTimeoutSeconds: 18000,
  }),
  "c0v-static-publish": Object.freeze({
    attemptId: PHASE10_C0V_S6_RECOVERY_V4_ATTEMPT_IDS["c0v-static-publish"],
    protocolPath: "research/phase10-execution-v2/recovery-v4/packets/c0v-static-publish/protocol.json",
    lockPath: PHASE10_C0V_S6_RECOVERY_V4_PACKET_LOCK_PATHS["c0v-static-publish"],
    outerInfrastructureSafetyTimeoutSeconds: 32400,
  }),
  "c0v-aggregate": Object.freeze({
    attemptId: PHASE10_C0V_S6_RECOVERY_V4_ATTEMPT_IDS["c0v-aggregate"],
    protocolPath: "research/phase10-execution-v2/recovery-v4/packets/c0v-aggregate/protocol.json",
    lockPath: PHASE10_C0V_S6_RECOVERY_V4_PACKET_LOCK_PATHS["c0v-aggregate"],
...
/** Reopens all four consumed generations and the separately registered recovery-v4 authority. */
export function phase10C0VS6AssertRecoveryPredecessorState(
  ...
  const authority = parsePhase10C0VS6RecoveryV4Authority(
    parsePhase10C0VS6PrettyJsonBytes(authorityBytes, "recovery-v4 authority"),
  );
  ...
  const predecessorRecoveryAuthority = parsePhase10C0VS6RecoveryV3Authority(
    parsePhase10C0VS6PrettyJsonBytes(predecessorRecoveryAuthorityBytes, "recovery-v3 authority"),
  );
  ...
  const earlierRecoveryAuthority = parsePhase10C0VS6RecoveryV2Authority(
    parsePhase10C0VS6PrettyJsonBytes(earlierRecoveryAuthorityBytes, "recovery-v2 authority"),
  );
  ...
  phase10C0VS6SameIdentity(
    ...
    "recovery-v3 catalogue predecessor",
  );
  const predecessorCatalogue = parsePhase10C0VS6PacketCatalogue(
    parsePhase10C0VS6PrettyJsonBytes(predecessorCatalogueBytes, "recovery-v2 catalogue"),
  );
  if (predecessorCatalogue.catalogueId !== PHASE10_C0V_S6_RECOVERY_V3_PACKET_CATALOGUE_ID ||
    predecessorCatalogue.recoveryAuthority === undefined) {
    fail("recovery-v3 catalogue predecessor mapping differs");
  }
  phase10C0VS6SameIdentity(
    predecessorCatalogue.recoveryAuthority,
    predecessorRecoveryAuthorityIdentity,
    "recovery-v3 catalogue authority binding",
  );
  ...
  phase10C0VS6SameIdentity(
    ...
    "recovery-v3 A-P protocol predecessor",
  );
  const predecessorApProtocol = parsePhase10C0VS6PacketProtocol(
    parsePhase10C0VS6PrettyJsonBytes(predecessorApProtocolBytes, "recovery-v2 A-P protocol"),
  );
  if (predecessorApProtocol.packetId !== "a-p-c0v-s6" ||
    predecessorApProtocol.registeredAttemptId !== "a-p-c0v-s6-20260822-v4" ||
    predecessorApProtocol.bindings.recoveryAuthority === undefined) {
    fail("recovery-v3 A-P protocol identity or attempt mapping differs");
  }
  phase10C0VS6SameIdentity(
    predecessorApProtocol.bindings.recoveryAuthority,
    predecessorRecoveryAuthorityIdentity,
    "recovery-v3 A-P authority binding",
  );
  ...
  if (mode === "post-ap" && checkedAbsentPaths.some((path) =>
    !PHASE10_C0V_S6_RECOVERY_V4_PREDECESSOR_GOVERNED_ABSENT_PATHS.includes(
      path as (typeof PHASE10_C0V_S6_RECOVERY_V4_PREDECESSOR_GOVERNED_ABSENT_PATHS)[number],
    ) &&
    !PHASE10_C0V_S6_RECOVERY_V4_STAGE_PATHS.includes(
      path as (typeof PHASE10_C0V_S6_RECOVERY_V4_STAGE_PATHS)[number],
    ))) {
    fail("post-A-P predecessor audit selected a path outside the retained v2/v3/v4/v5 absence roster");
  }
...
export function phase10C0VS6AssertPackageAndPacketLockBytes(
  ...
  if (locks.packageLock.schema !== "phase10-c0v-s6-lock-v1" ||
    locks.packageLock.packetId !== PHASE10_C0V_S6_RECOVERY_V4_PACKET_CATALOGUE_ID ||
...
export async function phase10C0VS6WithPackageAndPacketLocks<T>(
  ...
  if (registered === undefined) fail("CLI packet ID is not registered by execution-v2 recovery-v4");
          ...
          async (watchdog) => {
            ...
            try {
              ...
              if (catalogue.packageLockPath !== PACKAGE_LOCK_PATH ||
                ...
                catalogue.catalogueId !== PHASE10_C0V_S6_RECOVERY_V4_PACKET_CATALOGUE_ID ||
