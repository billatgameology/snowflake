...
function requireDeepPackageDependencyVerification(): void {
  fail("seven prior verification-v2/terminal-v2 receipts are not yet independently joined");
}
...
function inputs(request: Phase10C0VAggregateVerificationRequest): Inputs {
  ...
  requireDeepPackageDependencyVerification();
...
export function independentlyReprovePhase10C0VAnyLayerNonpass(
  ...
  receiptPath = "out/phase10-execution-v2/attempts/c0v-aggregate/synthetic/any-layer-nonpass-control.json",
