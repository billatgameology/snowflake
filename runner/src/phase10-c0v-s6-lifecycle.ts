...
const AP_WHOLE_FILE_PUBLICATION_OVERLAY = Object.freeze({
  "out-ap-c0v-s6-artifact-index": Object.freeze({
    ...
    currentPublicationPath: "evidence/phase10-obligation-preflight-v6/artifact-index.json",
  }),
  "out-ap-c0v-s6-missing-producer": Object.freeze({
    matrixPath: "evidence/phase10-obligation-preflight-v2/missing-producer.json",
    currentPublicationPath: "evidence/phase10-obligation-preflight-v6/missing-producer.json",
  }),
  "out-ap-c0v-s6-preflight": Object.freeze({
    ...
    currentPublicationPath: "evidence/phase10-obligation-preflight-v6/packets/a-p-c0v-s6/preflight.json",
  }),
  ...
  "out-ap-c0v-s6-uncalled-check": Object.freeze({
    ...
    currentPublicationPath: "evidence/phase10-obligation-preflight-v6/uncalled-check.json",
  }),
  "out-ap-c0v-s6-verification": Object.freeze({
    matrixPath: "evidence/phase10-obligation-preflight-v2/verification.json",
    currentPublicationPath: "evidence/phase10-obligation-preflight-v6/verification.json",
  }),
} as const);
