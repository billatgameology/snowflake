...
const REGISTRY_PATH =
  `${PHASE10_C0V_S6_RECOVERY_V8_AUTHORITY_ROOT}/packets/c0v-radial-produce/callable-registry.json` as const;
const ATTEMPT_PREFIX =
  `${PHASE10_C0V_S6_RECOVERY_V8_ATTEMPT_ROOT}/a-p-c0v-s6/` +
  `${PHASE10_C0V_S6_RECOVERY_V8_ATTEMPT_IDS["a-p-c0v-s6"]}/negative-controls`;
...
function witness(path: string, value: StrictJson): Phase10C0VS6ApMutationWitness {
  ...
  return Object.freeze({
    ...
    semanticFingerprint: Object.freeze({
      projection: semantic,
      sha256: phase10C0VS6CanonicalSemanticSha256(semantic),
    }),
  });
}
