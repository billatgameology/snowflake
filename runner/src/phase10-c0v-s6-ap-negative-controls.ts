...
const REGISTRY_PATH =
  "research/phase10-execution-v2/packets/c0v-radial-produce/callable-registry.json" as const;
const ATTEMPT_PREFIX =
  "out/phase10-execution-v2/attempts/a-p-c0v-s6/a-p-c0v-s6-20260822-v1/negative-controls" as const;
