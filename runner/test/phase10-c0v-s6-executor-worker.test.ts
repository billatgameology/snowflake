  ...
  return {
    ...
    derivePhase10C0VS6RetainedRuntimeAuthority: () => ({
      preflight: {
        ...
        observed: {
          candidateDirectory:
            "out/phase10-execution-v2/attempts/c0v-radial-produce/c0v-radial-produce-20260822-v1/candidate",
...
const workerArguments = Object.freeze([
  ...
  "--protocol", "research/phase10-execution-v2/packets/c0v-radial-produce/protocol.json",
...
describe("Phase 10 C0V S6 real worker dispatcher ACK state machine", () => {
  ...
  it("rejects any ambient row outside the exact launcher-provided worker environment", () => {
