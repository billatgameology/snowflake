  ...
  return {
    ...
    derivePhase10C0VS6RetainedRuntimeAuthority: () => ({
      preflight: {
        ...
        observed: {
          candidateDirectory:
    "out/phase10-execution-v2/recovery-v3/attempts/c0v-radial-produce/c0v-radial-produce-20260822-v1/candidate",
...
const workerArguments = Object.freeze([
  ...
  "--packet", "c0v-radial-produce",
      "--protocol", "research/phase10-execution-v2/recovery-v3/packets/c0v-radial-produce/protocol.json",
