...
const protocolPath = "research/phase10-execution-v2/recovery-v2/packets/c0v-radial-publish/protocol.json";
...
const candidateDirectory =
  "out/phase10-execution-v2/recovery-v2/attempts/c0v-radial-publish/" +
