...
const AP_OVERLAY_ROWS = Object.freeze([
  Object.freeze({
    ...
    currentPath: "evidence/phase10-obligation-preflight-v4/artifact-index.json",
  }),
  Object.freeze({
    outputId: "out-ap-c0v-s6-missing-producer",
    matrixPath: "evidence/phase10-obligation-preflight-v2/missing-producer.json",
    currentPath: "evidence/phase10-obligation-preflight-v4/missing-producer.json",
  }),
  Object.freeze({
    outputId: "out-ap-c0v-s6-preflight",
    matrixPath: "evidence/phase10-obligation-preflight-v2/packets/a-p-c0v-s6/preflight.json",
    currentPath: "evidence/phase10-obligation-preflight-v4/packets/a-p-c0v-s6/preflight.json",
  }),
  Object.freeze({
  ...
  Object.freeze({
    ...
    currentPath: "evidence/phase10-obligation-preflight-v4/uncalled-check.json",
  }),
  Object.freeze({
    outputId: "out-ap-c0v-s6-verification",
    matrixPath: "evidence/phase10-obligation-preflight-v2/verification.json",
    currentPath: "evidence/phase10-obligation-preflight-v4/verification.json",
  }),
] as const);
...
describe("Phase 10 C0V S6 lifecycle whole-file publication overlay", () => {
  it("resolves every exact immutable A-P v2 row to its fresh v4 publication path", () => {
