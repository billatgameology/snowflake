...
describe("Phase 10 C0V S6 filesystem and closure refusal boundary", () => {
  ...
  it("requires the live run-lock token and stays write-free until the implementation freeze is satisfiable", async () => {
    ...
    )).rejects.toThrow(/not resolved at implementation freeze/u);
